...
@Component({
  selector: 'app-highway-race-game',
  templateUrl: './highway-race-game.component.html',
  styleUrls: ['./highway-race-game.component.scss'],
})
export class HighwayRaceGameComponent implements AfterViewInit, OnDestroy {
